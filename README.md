...
- **[WeChat Bot Guide](skills/agent-wechatbot/SKILL.md)** — Official Account API integration for WeChat
...
For server-side bots and CI/CD, bot tokens are fully supported via [`agent-slackbot`](skills/agent-slackbot/SKILL.md), [`agent-discordbot`](skills/agent-discordbot/SKILL.md), [`agent-whatsappbot`](skills/agent-whatsappbot/SKILL.md), [`agent-channeltalkbot`](skills/agent-channeltalkbot/SKILL.md), and [`agent-wechatbot`](skills/agent-wechatbot/SKILL.md).
