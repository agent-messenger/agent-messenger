...
description: Give your AI agent the power to read and send messages across Slack, Discord, Teams, Channel Talk and more
icon: Info
---

Agent Messenger is a unified, agent-friendly CLI for messaging platforms. Zero-config credential extraction from your desktop apps—no OAuth flows, no API keys, no admin approval needed. Works out of the box. Supports Slack, Discord, Teams, and Channel Talk (beta).
...
Agent Messenger reads authentication tokens directly from your installed desktop apps (Slack, Discord, Teams, Channel Talk). These apps store session tokens locally, and Agent Messenger safely extracts them.
...
| **Multi-platform**  | Slack, Discord, Microsoft Teams, and Channel Talk (beta)                                                                          |
...
| **Bot support**     | [`agent-slackbot`](/docs/integrations/slackbot), [`agent-discordbot`](/docs/integrations/discordbot), and [`agent-channeltalkbot`](/docs/integrations/channeltalkbot) for server-side and CI/CD |
...
For these use cases, Agent Messenger also supports bot tokens via [`agent-slackbot`](/docs/integrations/slackbot), [`agent-discordbot`](/docs/integrations/discordbot), and [`agent-channeltalkbot`](/docs/integrations/channeltalkbot).
...
- [Channel Talk](/docs/integrations/channeltalk) - Full Channel Talk command reference (beta)
- [Channel Talk Bot](/docs/integrations/channeltalkbot) - Bot API integration for Channel Talk (beta)
