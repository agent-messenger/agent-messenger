...
description: Give your AI agent the power to read and send messages across Slack, Discord, Teams, Telegram, Channel Talk and more
icon: Info
---
...
| **Bot support**     | [`agent-slackbot`](/docs/slackbot), [`agent-discordbot`](/docs/discordbot), and [`agent-channeltalkbot`](/docs/channeltalkbot) for server-side and CI/CD |
...
For these use cases, Agent Messenger also supports bot tokens via [`agent-slackbot`](/docs/slackbot), [`agent-discordbot`](/docs/discordbot), and [`agent-channeltalkbot`](/docs/channeltalkbot).
...
- [Slack](/docs/slack) - Full Slack command reference
- [Slack Bot](/docs/slackbot) - Bot token integration for server-side and CI/CD
- [Discord](/docs/discord) - Full Discord command reference
- [Discord Bot](/docs/discordbot) - Bot token integration for server-side and CI/CD
- [Teams](/docs/teams) - Full Teams command reference
- [Telegram](/docs/telegram) - TDLib setup and Telegram command reference
- [Channel Talk](/docs/channeltalk) - Full Channel Talk command reference (beta)
- [Channel Talk Bot](/docs/channeltalkbot) - Bot API integration for Channel Talk (beta)
