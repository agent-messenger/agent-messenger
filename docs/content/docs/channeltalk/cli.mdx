...
Use **agent-channeltalk** when you want zero-config access acting as yourself. Use **[agent-channeltalkbot](/docs/channeltalkbot)** for server-side automation, CI/CD pipelines, or when you need bot-specific features like closing chats.
