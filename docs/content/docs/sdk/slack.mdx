...
The main client for interacting with Slack's API programmatically. All methods include automatic rate-limit retry with exponential backoff.
...
const messages = await client.getMessages(channel, { limit: 50, oldest: '1700000000.000000' })
// → SlackMessage[]
