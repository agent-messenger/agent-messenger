...
> **Tip**: After `npm install -g agent-messenger`, `agent-telegram` is available directly. If you prefer one-off execution without global install, `bunx --package agent-messenger agent-telegram ...` also works.
