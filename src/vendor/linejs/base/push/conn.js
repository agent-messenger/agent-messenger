import { LegyH2PingFrame, LegyH2PingFrameType, LegyH2PushFrame, LegyH2PushFrameType, LegyH2SignOnResponseFrame } from "./connData.js";
export class Conn {
  manager;
  h2Headers = [];
  isNotFinished = false;
